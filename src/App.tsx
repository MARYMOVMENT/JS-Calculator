...
function App() {
  ...
  const calculate = () => {
    ...
    if (isOperator(newExpression.charAt(0))) {
      // Using Function Constructor to perform calculation instead of eval
      setAnswer(new Function(`return ${answer + newExpression}`)().toString());
    } else {
    ...
    <>
      <div className='container'>
        ...
        <div id="calculator">
          ...
          <button id="zero" onClick={() => buttonPress("0")} className="dark-gray"></button>
